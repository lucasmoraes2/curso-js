...
var button = document.querySelector('.gerar-senha');
...
function gera() {
  var senha = Object(_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, checkMaiusculas.checked, checkMinusculas.checked, checkNumeros.checked, checkSimbolos.checked);
